...
import com.currencyconversion.CurrencyExchangeServiceProxy;
...
public class CurrencyConversionController {
    ...
    //It is more complex with resttemplate to call another microservice which can be solved with feign client
